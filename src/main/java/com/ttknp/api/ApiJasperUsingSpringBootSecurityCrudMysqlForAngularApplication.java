...
public class ApiJasperUsingSpringBootSecurityCrudMysqlForAngularApplication {

    public static void main(String[] args) {
        SpringApplication.run(ApiJasperUsingSpringBootSecurityCrudMysqlForAngularApplication.class, args);
    }
